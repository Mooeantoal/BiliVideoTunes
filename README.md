...
| 模块      | 描述                                      |
|---------|-----------------------------------------|
| UI      | [ ] 采用更加适合音乐播放器的UI，调整现有结构。              |
| UI      | [ ] 改良当前的响应式逻辑，为手机、平板、桌面提供支持。           |
| 播放器     | [ ] 重写当前滚动歌词逻辑，使得动画更加美观。                |
| 播放器     | [ ] 调整当前播放器逻辑，更好的支持播放队列和不同循环模式，同时提高扩展性。 |
| 播放器     | [ ] 支持掐头去尾功能。                           |
| 播放器     | [ ] 重新优化离线播放和播放记录持久化。                   |
| 播放器     | [ ] 支持定时播放和自动停止功能。                      |
| 播放器     | [ ] 支持UP稿件更多功能，比如点赞，投币，收藏入歌单，分享等功能。     |
| 个人中心    | [ ] 完善我的歌单，支持创建歌单和分享歌单。                 |
| 个人中心    | [ ] 完善历史播放页面，支持搜索。                      |
| 个人中心    | [ ] 支持退出登录。                             |
| 动态/订阅   | [ ] 支持订阅UP主动态。                          |
| Android | [ ] 支持通过分享链接进入音乐详情                      |
| Windows | [ ] Windows进入测试版本                       |
| MacOS   | [ ] MacOS进入测试版本                         |
