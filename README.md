...
<table>
    ...
    <tbody>
        <tr>
            <td rowspan="2">UI</td>
            <td>[ ] 采用更加适合音乐播放器的UI，调整现有结构。</td>
        </tr>
        <tr>
            <td>[ ] 改良当前的响应式逻辑，为手机、平板、桌面提供支持。</td>
        </tr>
        <tr>
            <td rowspan="8">播放器</td>
            <td>[ ] 重写当前滚动歌词逻辑，使得动画更加美观。</td>
        </tr>
        <tr>
            <td>[ ] 调整当前播放器逻辑，更好的支持播放队列和不同循环模式，同时提高扩展性。</td>
        </tr>
        <tr>
            <td>[ ] 支持掐头去尾功能。</td>
        </tr>
        <tr>
            <td>[ ] 重新优化离线播放和播放记录持久化。</td>
        </tr>
        <tr>
            <td>[ ] 支持定时播放和自动停止功能。</td>
        </tr>
        <tr>
            <td>[ ] 支持UP稿件更多功能，比如点赞，投币，收藏入歌单，分享等功能。</td>
        </tr>
        <tr>
            <td rowspan="3">个人中心</td>
            <td>[ ] 完善我的歌单，支持创建歌单和分享歌单。</td>
        </tr>
        <tr>
            <td>[ ] 完善历史播放页面，支持搜索。</td>
        </tr>
